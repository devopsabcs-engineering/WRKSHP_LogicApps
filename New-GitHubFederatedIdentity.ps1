param (
    [Parameter()]
    [string]
    $displayName = "GH__devopsabcs_engineering__WRKSHP_LogicApps", #"<your-service-principal-name>"
    [Parameter()]
    [string]
    $githubRepo = "devopsabcs-engineering/WRKSHP_LogicApps", #"<your-github-username>/<your-repo-name>"
    [Parameter()]
    [string]
